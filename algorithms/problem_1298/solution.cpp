...
int main() {
    ...
    // Output: 1
    //status = {1,1,1}, candies = {100,1,100}, keys = {{},{0,2},{}};
    ...
    // Output: 7
    //status = {1,1,1}, candies = {2,3,2}, keys = {{},{},{}}, containedBoxes = {{},{},{}};
    //initialBoxes = {2,1,0};

    cout << "Result: " << sol.maxCandies(status, candies, keys, containedBoxes, initialBoxes) << endl;
