...
292. Nim Game
    ...
    Total Accepted: 79712
    Total Submissions: 148547
    Difficulty: Easy
...
public class Solution {
    ...
    public boolean canWinNim_slow(int n) {
        boolean[] cache = new boolean[] {true, true, true};
    ...
    public static void main(String[] args) {
        ...
        int n = 1348820612;
        System.out.println(n + "  -->  " + sol.canWinNim(n));
    }
}
