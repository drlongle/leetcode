class Solution {
  public:
    ...
    int removeStones(vector<vector<int>> &stones) {
        // if two stones shares the same row or the same column, they are in
        // same group and we want  just one stone to remove all other stone in a
        // group .
        // hence question is count the connected component in a graph.
        // use dfs.
        //  Hence our answer will be total count - the number of the connected
        //  components
