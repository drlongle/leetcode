/*
- Create a prefix sum vector<vector<int>(26)> where each of the inner vector will contain the count of alphabets till
index i of string s.
...
vector<bool> canMakePaliQueries(string s, vector<vector<int>>& queries)
{
    ...
    for (auto const& q : queries) {
        ...
        // we can change odds/2 elements to match other odds/2 elements so odds/2<=k or rewriting it as
        // odds<=2*k(considering odds can be odd ^_^)
