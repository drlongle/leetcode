...
public:
    bool book(int start, int end) {
        for (auto it = slots.begin(); it != slots.end() && end > it->start; ++it) {
...
void test_1()
{
    ...
    cout << boolalpha << calendar.book(10, 20) << endl; // returns true
    cout << boolalpha << calendar.book(50, 60) << endl; // returns true
    cout << boolalpha << calendar.book(10, 40) << endl; // returns true
    cout << boolalpha << calendar.book(5, 15) << endl; // returns false
    cout << boolalpha << calendar.book(5, 10) << endl; // returns true
    cout << boolalpha << calendar.book(25, 55) << endl; // returns true
}

void test_2()
{
    vector<pair<int, int>> slots = {{26,35},{26,32},{25,32},{18,26},{40,45},{19,26},{48,50},{1,6},{46,50},{11,18}};
    MyCalendarTwo calendar;
    for (auto& slot: slots) {
