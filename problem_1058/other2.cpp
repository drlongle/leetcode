/*
Determine how many numbers needs to be floored to meet the target. Then sort the numbers
by their decimal places and pick the smallest ones to floor.

I multiply numbers by 1,000 to avoid dealing with the floating point and rounding errors.
*/
